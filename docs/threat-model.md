...
- **Routing assessments and model profiles:** contributor- or model-supplied estimates of complexity, capability, availability, and relative cost. They are advisory inputs, not verified provider facts. The selector may exclude candidates deterministically but cannot prove that the selected model exists, was invoked, or has the claimed quality or price.
